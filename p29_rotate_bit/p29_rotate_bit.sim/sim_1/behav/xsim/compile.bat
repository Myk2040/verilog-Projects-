...
REM
REM Generated by Vivado on Mon Mar 18 07:33:30 +0100 2024
...
echo "xvlog --incr --relax -prj rotate_bit_tb_vlog.prj"
call xvlog  --incr --relax -prj rotate_bit_tb_vlog.prj -log xvlog.log

...
REM
REM Generated by Vivado on Sat Oct 26 10:31:52 +0200 2024
...
echo "xvlog --incr --relax -prj SRAM_1024x36_bidir_vlog.prj"
call xvlog  --incr --relax -prj SRAM_1024x36_bidir_vlog.prj -log xvlog.log

...
HD_PWD='C:/Users/mayan/OneDrive/Desktop/project/p4_mux2.1/p4_mux2.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2j1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux2j1.tcl
